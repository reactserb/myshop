			...
			>
				...
				{productsFound ? (
                   ...
                   xl:hidden'
								></div>
								<ul
									className={`flex flex-row flex-nowrap overflow-x-auto gap-10 px-5 xl:flex-wrap xl:overflow-x-visible xl:${isOrderPage && products.length < 3 ? '' : 'justify-around'}`}
								>
                    			...
                    			${!applyIndexStyles && index > 3 ? 'xl:hidden' : ''}
