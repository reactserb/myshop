			...
			<div className='flex items-center justify-between mb-4'>
				...
				<div className='flex gap-2'>
					<button
						...
						className={`${buttonStyles.active} [&&]:px-3 [&&]:text-sm rounded cursor-pointer hover:bg-gray-400`}
					>
						Найти
					</button>
					<button
						onClick={onClearFilters}
						className='px-3 py-2 text-sm justify-center items-center border-none rounded cursor-pointer transition-colors duration-300 bg-gray-200 hover:bg-red-300'
					>
						Очистить
					</button>
				</div>
