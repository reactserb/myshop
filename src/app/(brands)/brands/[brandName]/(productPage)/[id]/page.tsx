...
export async function generateMetadata({
	...
	try {
		...
		return {
			title: `${product.title}`,
			description: `Заказывайте ${product.description} ${product.title} по лучшей цене. Быстрая доставка, гарантия качества.`,
			openGraph: {
				title: product.title,
				description:
	...
	try {
		...
		return (
			<ErrorComponent
				...
				userMessage='Не удалось загрузить данные о товаре'
			/>
		)
	}
