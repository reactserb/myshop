...
const EnterPasswordContent = () => {
	...
	return (
		<AuthFormLayout>
			<h1 className='text-2xl font-bold text-black text-center mb-8'>Вход</h1>
			<form
            ...
            my-8`}
				...
				<div className='flex flex-row flex-wrap mx-auto text-xs'>
					<button
						...
						className='h-8 text-gray-600 hover:text-black w-30 flex items-center justify-center gap-x-2 duration-300 cursor-pointer'
					>
