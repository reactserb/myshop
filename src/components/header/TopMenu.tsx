...
const TopMenu = () => {
	return (
		<ul className='fixed bottom-0 left-0 right-0 bg-gray-100 md:static md:bg-transparent flex gap-x-2 md:gap-x-0 justify-around items-center w-full px-4 py-2 z-50'>
			<li>
