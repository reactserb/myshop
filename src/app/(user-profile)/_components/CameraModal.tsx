...
const CameraModal = ({
	...
	return (
		<div className='fixed inset-0 bg-[#ffffffcc] backdrop-blur-sm flex items-center justify-center z-[150] p-4 rounded'>
			<div className='bg-white border-1 border-gray-500 rounded p-4 max-w-sm w-full'>
